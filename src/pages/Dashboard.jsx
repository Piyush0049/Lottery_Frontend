  ...
  return (
    <div className="min-h-screen font-poppins bg-gradient-to-b from-gray-900 to-black text-white">
      ...
      <div className="container mx-auto px-4 mb-10">
        <div className="max-w-4xl mx-auto bg-gray-800/30 backdrop-blur-sm p-8 rounded-xl border border-gray-700/50 shadow-xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-gray-400">Connect your wallet to enter raffles</p>
              </div>
            </div>
          ...
          {!walletInstalled && (
            <div className="mt-6 bg-gradient-to-r from-red-500/80 to-red-600/80 backdrop-blur-sm text-white px-6 py-4 rounded-lg flex items-center">
              <FaExclamationTriangle className="text-xl mr-3" />
              <div>
                <p>No wallet detected! Please install{" "}
                  <a
      ...
      <div className="container mx-auto px-4 mb-16">
        <div className="grid grid-cols-1 md:grid-cols-1 gap-8 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 p-8 rounded-xl backdrop-blur-sm border border-gray-700/50 shadow-xl hover:shadow-purple-500/10 transition-all">
            <div className="flex items-center mb-6">
              <div className="bg-purple-500/20 p-3 rounded-lg mr-4">
                <FaChartLine className="text-2xl text-purple-400" />
              </div>
              <h2 className="text-xl font-bold">Enter Raffle</h2>
            </div>
      ...
      <div className="container mx-auto px-4 pb-16 text-center">
        <Link 
          to="/" 
          className="px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg font-medium hover:shadow-lg hover:shadow-purple-500/20 transition-all inline-block"
        >
          Return to Home
        </Link>
      </div>
